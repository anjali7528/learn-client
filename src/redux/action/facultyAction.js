...
const FacultyGetAllResult = (data) => {
    return {
        type: "FETCH_RESULT",
        payload: data
    }   
...
export const uploadQuiz = (props) => {
    return async (dispatch) => {
        try {
            await axios({
                method: 'Post',
                url: url + "/api/faculty/createQuiz",
                data: {...props}
            })
...
export const factultyFetchQuiz = (creatorID) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: url + "/api/faculty/allQuiz",
                data: creatorID
            })
            dispatch(FacultyGetAllQuiz(data))
        }
        catch (err) {
            dispatch({
                type: SET_ERRORS,
...
export const facultyFetchResult = () => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: url + "/api/faculty/QuizResult",
            })
            dispatch(FacultyGetAllResult(data))
        }
        catch (err) {
            dispatch({
                type: SET_ERRORS,
