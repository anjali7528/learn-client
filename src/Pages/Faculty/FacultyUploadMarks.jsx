                ...
                {store.faculty.fetchedStudentsHelper && <div className="row justify-content-center mt-4 ">
                    <div className="col-md-4">
                        <form noValidate onSubmit={formHandler}>
                            ...
                            <button type="submit" className="btn" style={{backgroundColor:"#388688", color:"white" }}>Search</button>
                        </form>
                    </div>
                </div>}
                ...
                {!store.faculty.fetchedStudentsHelper && <div className="row  justify-content-center mt-4">
                    <div className="col-md-4">
                        <form onSubmit={secondFormHandler}>
                            ...
                            <button type="submit" className="btn  ml-1" style={{backgroundColor:"#388688", color:"white" }}>Submit</button>
                        </form>
                    </div>
                </div>
                }
