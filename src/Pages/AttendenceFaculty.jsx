                ...
                {store.faculty.fetchedStudentsHelper && <div className="row justify-content-center mt-4 ">
                    <div className="col-md-4">
                        <form noValidate onSubmit={formHandler}>
                            ...
                            {!isLoading && <button type="submit" className="btn"  style={{backgroundColor:"#388688", color:"white" }}>Search</button>}
                        </form>
                    </div>
                </div>}
                ...
                {!store.faculty.fetchedStudentsHelper && <div className="row  justify-content-center mt-4">
                    <div className="col-md-4">
                        <form onSubmit={secondFormHandler}>
                            ...
                            {!isLoading2 && <button type="submit" style={{backgroundColor:"#388688", color:"white" }} className="btn  ml-1  ">Submit</button>}
                        </form>
                    </div>
                </div>
                }</> : (history.push('/'))}
