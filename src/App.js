...
import FacultyCreateQuiz from './Pages/FacultyCreateQuiz';
import FacultyshowAllQuiz from './Pages/FacultyshowAllQuiz';
import StudentPlayQuiz from './Pages/Student/StudentPlayQuiz';
import StudentViewResult from './Pages/StudentViewResult';
import FacultyViewResult from './Pages/FacultyViewResult';
    ...
    <div>
      <Router>
        <Switch>
          ...
          <Route exact path="/faculty/viewResult" component={FacultyViewResult} />
          <Route exact path="/faculty/updateProfile" component={FacultyUpdateProfile} />
          <Route exact path="/faculty/createQuiz" component={FacultyCreateQuiz} />
          <Route exact path="/faculty/showQuiz" component={FacultyshowAllQuiz} />
          <Route exact path="/student/getAllSubjects" component={StudentSubjectList} />
          <Route exact path="/student/quizResult" component={StudentViewResult} />
          <Route exact path="/student/playQuiz" component={StudentPlayQuiz} />
